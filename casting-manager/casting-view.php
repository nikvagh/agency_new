<?php 
  ...
  if(isset($_POST['submit']) && $_POST['submit'] == "Delete Casting"){
    ...
    if(mysql_query($dsql5)){
      ...
      header("Location: casting-call.php");
    }
  }
              ...
              <div class="col-md-12">
                ...
                <div class="box box-theme">
                  <div class="box-header with-border">
                    <div class="row">
                        <div class="col-sm-6"><h3 class="box-title">Casting Information : <?php echo $row['job_title']; ?></h3></div>
                        <div class="col-sm-6 text-right">
                          <!-- <a href="submission.php?casting_id=<?php echo $row['casting_id']; ?>" class="btn btn-sm btn-success btn-flat" target="_blank">View All Submission</a> -->
                        </div>
                    </div>
                  </div>
                ...
                <?php while ($role_row = mysql_fetch_array($casting_role_q, MYSQL_ASSOC)) { ?>
                  ...
                  <div class="col-md-12">
                    <div class="box">
                      ...
                      <div class="box-header with-border">
                        <div class="row">
                            <div class="col-sm-6"><h3 class="box-title">Role Descriptions : <?php echo $role_row['name']; ?></h3></div>
                            <div class="col-sm-6 text-right">
                              <a href="submission.php?casting_id=<?php echo $row['casting_id']; ?>&role_id=<?php echo $role_row['role_id']; ?>" class="btn btn-sm btn-success btn-flat" target="_blank">View Submission</a>
                              <a href="audition.php?casting_id=<?php echo $row['casting_id']; ?>&role_id=<?php echo $role_row['role_id']; ?>" class="btn btn-sm btn-warning btn-flat" target="_blank">Audition </a>
                              <a href="booked_audition.php?casting_id=<?php echo $row['casting_id']; ?>&role_id=<?php echo $role_row['role_id']; ?>" class="btn btn-sm btn-theme btn-flat" target="_blank">Booked</a>
                            </div>
                        </div>
