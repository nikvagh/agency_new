	        ...
	        <?php //} ?>
				...
				if (isset($_POST['job_title'])) {
					...
					if (true) {
						...
						if(!empty($_POST['posted_on'])){

							$date = escape_data($_POST['posted_on'] . ':00');
							$sql_ary = array(
											'posted_by' => $loggedin,
											'casting_director' => $loggedin, 
						...
						if (true && $verified == true) {
							...
							if (mysql_query($sql)) {
								...
								if($casting_insert == 'Y'){
									...
									$sub_admins = get_all_sub_admin();
									foreach($sub_admins as $val){

										$to = $val['user_email'];
										$subject = "New Casting Call";
										$msg = "New Casting Call Created by ".$user['firstname']." ".$user['lastname'];

										$sql_ins_notification = "INSERT INTO agency_notification 
																	SET 
										...
										mysql_query($sql_ins_notification);
								...
								<div class="box box-theme">
						            ...
						            <div class="box-footer">
										...
										<div class="text-right">
											<a type="button" href="casting-call.php" class="btn btn-default">Cancel</a>
