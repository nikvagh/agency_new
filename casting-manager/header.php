		              ...
		              <li>
		                <ul class="menu">
							<?php if (mysql_num_rows($query_notification) > 0) { ?>
								<?php while ($row = mysql_fetch_array($query_notification, MYSQL_ASSOC)) { ?>
									<li>
	        ...
	        <div class="collapse navbar-collapse navbar-ex1-collapse">
	            <ul class="nav navbar-nav side-nav">
	                ...
	                <li><a href="index.php" class="<?php if($page_selected == 'dashboard'){ echo 'active'; } ?>">DASHBOARD</a></li>
				  	...
				  	<li><a href="casting-call.php" class="<?php if($page_selected == 'casting_calls'){ echo 'active'; } ?>">CASTING CALLS</a></li>
				  	<li><a href="clienthome.php" class="<?php if($page_selected == 'talent_search'){ echo 'active'; } ?>">SEARCH FOR TALENT</a></li>
				  	...
				  	<li><a href="project-list.php" class="<?php if($page_selected == 'my_projects'){ echo 'active'; } ?>">MY PROJECTS</a></li>
				  	...
				  	<li><a href="edit-profile.php" class="<?php if($page_selected == 'edit_profile'){ echo 'active'; } ?>">MY ACCOUNT</a></li>
