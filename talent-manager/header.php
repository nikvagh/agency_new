...
<head>
	...
	<?php if($page == "schedule"){ ?>
		<link rel="stylesheet" href="../dashboard/assets/fullcalendar/fullcalendar.min.css">
	  	<link rel="stylesheet" href="../dashboard/assets/fullcalendar/fullcalendar.print.css" media="print">
	<?php } ?>
	        ...
	        <div class="collapse navbar-collapse navbar-ex1-collapse">
	            <ul class="nav navbar-nav side-nav">
	                ...
	                <li><a href="index.php" class="<?php if($page_selected == 'dashboard'){ echo 'active'; } ?>">DASHBOARD</a></li>
				  	...
				  	<li><a href="casting-calls.php" class="<?php if($page_selected == 'casting_call'){ echo 'active'; } ?>">CASTING CALLS</a></li>
					...
					<li><a href="roster.php" class="<?php if($page_selected == 'roster'){ echo 'active'; } ?>">ROSTER</a></li>
					<!-- <li>
						<?php
							$setting_active = 'N';
							if($page_selected == 'affiliate' || $page_selected == 'affiliate' || $page_selected == 'affiliate'){ 
								$setting_active = 'Y';
							}
						?>
						<a href="#" data-toggle="collapse" data-target="#member_sub" class="<?php if($setting_active == 'Y'){ echo 'active'; } ?>">SETTINGS</a>
						<ul id="member_sub" class="treeview-menu collapse <?php if($setting_active == 'Y'){ echo 'in'; } ?>">
							<li>
								<a href="mentors.php" class="<?php if($page_selected == 'affiliate'){ echo 'active'; } ?>">
				  	...
				  	<li><a href="article-list.php" class="<?php if($page_selected == 'article_list'){ echo 'active'; } ?>">SUBMIT AN ARTICLE</a></li>
