			                ...
			                <div class="box box-theme">
			                	...
			                	<div class="box-header with-border">
			                		<div class="text-right">
			                			<?php if($success) { ?>
								        	<a class="btn btn-theme btn-flat" href="mentors.php?new=true">Add New Mentor</a>
								        <?php } ?>
								        	...
								        	<tbody>
								        		...
								        		?>
								        				<tr>
								        					...
								        					<td><?php echo $Code; ?></td>
								        					<td>
								        						<a href="mentor_view.php?id=<?php echo $MentorID; ?>" class="btn btn-theme btn-flat btn-sm">View Details</a>
							        						</td>
							        					</tr>
								        			<?php } ?>
								        		<?php } ?>
