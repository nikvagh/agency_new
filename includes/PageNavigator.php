...
class PageNavigator{
	...
	private $inactivenum = "inactivenum";
	private $pagedisplaydivname = "totalpagesdisplay";
	private $divwrappername = "navigator";
	//text for navigation
	private $strfirst = "<i class='fa fa-angle-double-left'></i>";
	private $strnext = "Next";
	private $strprevious = "Prev";
	private $strlast = "<i class='fa fa-angle-double-right'></i>";
  //for error reporting
	private $errorstring;	
////////////////////////////////////////////////////////////////////
//constructor
	...
	public function getNavigator(){
		...
		for($x=$this->currentstartpage;$x<$this->currentendpage;$x++){
			...
			if($x==$this->currentpage){
				$strnavigator.= "<span class=\"$this->inactivenum btn btn-theme btn-flat\" >";
				$strnavigator.= $x+1;
				$strnavigator.= "</span>\n";
			}else{
...
////////////////////////////////////////////////////////////////////
	private function createLink($offset, $strdisplay ){
		...
		$strtemp.= $offset;
		$strtemp.= "$this->params\" class='btn btn-default btn-flat'>$strdisplay</a>\n";
		return $strtemp;
	}
////////////////////////////////////////////////////////////////////	
