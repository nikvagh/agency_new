...
<?php				
	...
	if(isset($profileid)) {
		...
		?>
		<div align="right" style="position:absolute; width:600px; margin-top:-30px" onmouseover="document.getElementById('experience_popup').style.display=''" onmouseout="document.getElementById('experience_popup').style.display='none'"><b>WHAT IS: &nbsp;</b><font color="#0000ff"><b>NEW FACES</b></font><b> </b><font color="#ff0000"><b>EXPERIENCED</b></font><b> PROFESSIONAL ?</b></div>
		<?php
		...
		mailed from http://www.theagencyonline.com";
							...
							if(!empty($row['casting_id'])) {
								...
								echo 'This lightbox is linked with the casting: <a target="_blank" href="news.php?castingid='. $castingid . '"><b>' . $castingname . '</b></a>';
