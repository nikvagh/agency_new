...
if (agency_account_type() == 'client' && is_active()) { // only clients can access this page
	...
	if (isset($_POST['submit'])) { // Handle the form.
		...
		if (true) {
			...
			if (true && $verified == true) { // no need for verification here, there will be a redirect if $verified=false.  This is so images upload
...
?>
		...
		<div class="AGENCY_ClientPageTitle">Casting Information</div>
			...
			<form enctype="multipart/form-data" action="castingupdate.php<?php if (!empty($_GET['castingid'])) echo '?castingid=' . escape_data((int) $_GET['castingid']); ?>" method="post" name="casting" id="AGENCYcastingform">
				<div style="margin-left:10px; width:310px; float:left">
					<table border="0" cellpadding="3" cellspacing="3" align="left">
						...
						<tr>
							<td class="AGENCYregtableleft" <?php if (isset($job_title) && empty($job_title)) {
																echo ' style="color:#FF0000"';
															} ?>><b>Project Name (artist / product / campaign / magazine / etc):</b></td>
						...
						<tr>
							<td class="AGENCYregtableleft" <?php if (isset($location_casting) && empty($location_casting)) {
																echo ' style="color:#FF0000"';
															} ?>><b>Casting Location:</b></td>
						...
						<tr>
							<td class="AGENCYregtableleft" <?php if (isset($location_shoot) && empty($location_shoot)) {
																echo ' style="color:#FF0000"';
															} ?>><b>Shoot Location:</b></td>
							<td class="AGENCYregtableright">
						...
						<tr>
							<td class="AGENCYregtableleft" <?php if (isset($shoot_date) && empty($shoot_date)) {
																echo ' style="color:#FF0000"';
															} ?>><b>Shoot Date/Range:</b></td>
							<td class="AGENCYregtableright"><textarea name="shoot_date" style="height:35px"><?php if (!empty($shoot_date)) echo $shoot_date; ?></textarea>
							</td>
						</tr>
						<tr>
							<td class="AGENCYregtableleft" <?php if (isset($casting_date) && empty($casting_date)) {
																echo ' style="color:#FF0000"';
															} ?>><b>Casting Date:</b></td>
						...
						<tr>
							<td class="AGENCYregtableleft" <?php if (isset($casting_director) && empty($casting_director)) {
																echo ' style="color:#FF0000"';
															} ?>><b>Casting Director:</b></td>
							...
							<tr>
								...
								<td class="AGENCYregtableright">
									...
									if (isset($_POST['Month_start'])) {
										if ($_POST['Month_start'] == "01") {
											echo " selected";
										}
									} else if ($MO == "01") echo " selected";
									echo ">January</OPTION>\n";
									echo "<OPTION VALUE=02";
									if (isset($_POST['Month_start'])) {
										if ($_POST['Month_start'] == "02") {
											echo " selected";
										}
									} else if ($MO == "02") echo " selected";
									echo ">February</OPTION>\n";
									echo "<OPTION VALUE=03";
									if (isset($_POST['Month_start'])) {
										if ($_POST['Month_start'] == "03") {
											echo " selected";
										}
									} else if ($MO == "03") echo " selected";
									echo ">March</OPTION>\n";
									echo "<OPTION VALUE=04";
									if (isset($_POST['Month_start'])) {
										if ($_POST['Month_start'] == "04") {
											echo " selected";
										}
									} else if ($MO == "04") echo " selected";
									echo ">April</OPTION>\n";
									echo "<OPTION VALUE=05";
									if (isset($_POST['Month_start'])) {
										if ($_POST['Month_start'] == "05") {
											echo " selected";
										}
									} else if ($MO == "05") echo " selected";
									echo ">May</OPTION>\n";
									echo "<OPTION VALUE=06";
									if (isset($_POST['Month_start'])) {
										if ($_POST['Month_start'] == "06") {
											echo " selected";
										}
									} else if ($MO == "06") echo " selected";
									echo ">June</OPTION>\n";
									echo "<OPTION VALUE=07";
									if (isset($_POST['Month_start'])) {
										if ($_POST['Month_start'] == "07") {
											echo " selected";
										}
									} else if ($MO == "07") echo " selected";
									echo ">July</OPTION>\n";
									echo "<OPTION VALUE=08";
									if (isset($_POST['Month_start'])) {
										if ($_POST['Month_start'] == "08") {
											echo " selected";
										}
									} else if ($MO == "08") echo " selected";
									echo ">August</OPTION>\n";
									echo "<OPTION VALUE=09";
									if (isset($_POST['Month_start'])) {
										if ($_POST['Month_start'] == "09") {
											echo " selected";
										}
									} else if ($MO == "09") echo " selected";
									echo ">September</OPTION>\n";
									echo "<OPTION VALUE=10";
									if (isset($_POST['Month_start'])) {
										if ($_POST['Month_start'] == "10") {
											echo " selected";
										}
									} else if ($MO == "10") echo " selected";
									echo ">October</OPTION>\n";
									echo "<OPTION VALUE=11";
									if (isset($_POST['Month_start'])) {
										if ($_POST['Month_start'] == "11") {
											echo " selected";
										}
									} else if ($MO == "11") echo " selected";
									echo ">November</OPTION>\n";
									echo "<OPTION VALUE=12";
									if (isset($_POST['Month_start'])) {
										if ($_POST['Month_start'] == "12") {
											echo " selected";
										}
									} else if ($MO == "12") echo " selected";
									...
									while ($Day <= 31) {
										...
										if (isset($_POST['Day_start'])) {
											if ($_POST['Day_start'] == $Day) {
												echo " selected";
											}
										} else if ($DY == $Day) echo " selected";
										echo ">$Day</OPTION>\n";
										$Day++;
									}
									echo "</SELECT>&nbsp;&nbsp;";
									...
									while ($Year <= $Yearcount) {
										...
										if (isset($_POST['Year_start'])) {
											if ($_POST['Year_start'] == $Year) {
												echo " selected";
											}
										} else if ($Year == $YR) echo " selected";
										echo ">$Year</OPTION>\n";
										$Year++;
									}
									echo "</SELECT><br />at&nbsp;&nbsp;";
									...
									while ($Hour <= 12) {
										...
										if (isset($_POST['Hour_start'])) {
											if ($_POST['Hour_start'] == $Hour) {
												echo " selected";
											}
										} else if ($Hour == $HR) echo " selected";
										echo ">$Hour</OPTION>\n";
										$Hour++;
									}
									echo "</SELECT>&nbsp;&nbsp;";
									...
									while ($Minute <= 59) {
										...
										if (isset($_POST['Minute_start'])) {
											if ($_POST['Minute_start'] == $Minute) {
												echo " selected";
											}
										} else if ($Minute == $MN) echo " selected";
										echo " >$Minute</OPTION>\n";
										$Minute += 15;
									}
									echo "</SELECT>&nbsp;&nbsp;";
									...
									if (isset($_POST['AMPM_start'])) {
										if ($_POST['AMPM_start'] == "AM") {
											echo " selected";
										}
									} else if ($AP == "AM") echo ' selected';
									echo ">AM</OPTION>\n";
						...
						<tr>
							<td class="AGENCYregtableleft" <?php if (isset($rate_day) && empty($rate_day)) {
																echo ' style="color:#FF0000"';
															} ?>><b>Day Rate:</b></td>
						...
						<tr>
							<td class="AGENCYregtableleft" <?php if (isset($rate_usage) && empty($rate_usage)) {
																echo ' style="color:#FF0000"';
															} ?>><b>Usage Rate:</b></td>
				...
				<div style="width:317px; float:right; margin-right:12px">
					<table border="0" align="left">
						...
						<tr>
							<td>
								<div style="height:1794px; overflow-y:auto; overflow-x:hidden; width:100%">
									<table width="100%" border="0" cellpadding="3" cellspacing="3" align="left">
										<tr>
											<td class="AGENCYregtableleft" <?php if (isset($roleRed)) {
																				echo ' style="color:#FF0000"';
																			} ?>>Character Name:</td>
										...
										<tr>
											<td class="AGENCYregtableleft" <?php if (isset($ageRed)) {
																				echo ' style="color:#FF0000"';
																			} ?>>Age Range:</td>
										...
										<tr>
											<td class="AGENCYregtableleft" <?php if (isset($genderRed)) {
																				echo ' style="color:#FF0000"';
																			} ?>>Gender:</td>
											<td class="AGENCYregtableright">
										...
										<tr>
											<td class="AGENCYregtableleft" <?php if ($ethnicityRed) {
																				echo ' style="color:#FF0000"';
																			} ?>>Ethnicity:</td>
											<td class="AGENCYregtableright">
		...
		$allflag = false;
				...
				<div style="clear:both; padding:20px">
					...
					<input type="hidden" name="stopdouble" value="<?php $_SESSION['stopdouble'] = time();
																	echo $_SESSION['stopdouble']; ?>" />
