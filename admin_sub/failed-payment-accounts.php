<?php
	$page = "failed_payment_accounts_list";
	$page_selected = "failed_payment_accounts";
	include('header.php');
							...
							<table class="datatable table table-responsive table-striped">
								...
								<tbody>
									<?php
										...
										$result = mysql_query("SELECT forum_users.user_id, forum_users.user_email, forum_users.username, agency_profiles.account_type, agency_profiles.firstname, agency_profiles.lastname, agency_profiles.register_browser FROM forum_users, agency_profiles WHERE agency_profiles.user_id=forum_users.user_id AND agency_profiles.payFailed = '1' AND (agency_profiles.account_type='talent' OR agency_profiles.account_type='client' OR agency_profiles.account_type='talent_manager') ORDER BY forum_users.user_id DESC
											");
