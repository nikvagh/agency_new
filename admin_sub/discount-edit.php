...
if(isset($_GET['discount_id'])){
	$sql_select = "SELECT * FROM agency_discounts WHERE discount_id=".$_GET['discount_id']."";
...
if(isset($_POST) && !empty($_POST)){
	...
	$sql_ins = "UPDATE agency_discounts 
				SET 
								...
								<div class="box box-theme">
						            <div class="box-body">
						            	<div class="form-group">
						                  	...
						                  	<input type="text" class="form-control" name="code" id="code" placeholder="Enter Code" value="<?php echo $discount['code']; ?>">
						                </div>

						                <div class="form-group">
						                  	<label class="control-label text-right">Weeks </label>
						                  	<input type="text" class="form-control" name="weeks" id="weeks" placeholder="Enter Weeks" value="<?php echo $discount['weeks']; ?>">
						                </div>

						                <div class="form-group">
						                  	<label class="control-label text-right">Days </label>
						                  	<input type="text" class="form-control" name="days" id="days" placeholder="Enter Days" value="<?php echo $discount['days']; ?>">
						                </div>

						                <div class="form-group">
						                  	<label class="control-label text-right">Maximum Number Of Usage *</label>
						                  	<input type="text" class="form-control" name="max_use" id="max_use" placeholder="Enter Maximum Number Of Usage" value="<?php echo $discount['max_use']; ?>">
						                </div>

						                <div class="form-group">
						                  	<label class="control-label text-right">% off Membership </label>
						                  	<input type="number" class="form-control" name="percentage" id="percentage" placeholder="Enter % off Membership" min="0" max="100" value="<?php echo $discount['percentage']; ?>">
						                </div>
						                ...
						                <div class="form-group">
					                  		...
					                  		<select class="form-control" name="status" id="status">
					                  			...
					                  			<option value="Enable" <?php if($discount['status'] == "Enable"){ echo "selected"; } ?> >Enable</option>
					                  			<option value="Disable" <?php if($discount['status'] == "Disable"){ echo "selected"; } ?> >Disable</option>
					                  		</select>
						                </div>
						            </div>
						            ...
						            <div class="box-footer">
										...
										<div class="text-right">
											<a type="button" href="discount-list.php" class="btn btn-flat btn-default">Cancel</a> &nbsp;
											<!-- <input type="button" value="Submit" name="submit" class="btn btn-theme btn-submit"/> -->
											<input type="hidden" name="discount_id" id="discount_id" value="<?php echo $discount['discount_id']; ?>" />
			...
			rules: {
				code: {
					...
					remote: {
				        ...
				        type: "post",
				        data: {
					        name:'dicount_code_unique_upadte',
