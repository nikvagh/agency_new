  ...
  <div class="container-fluid">
    ...
    <div class="well" id="main">
      ...
      <div align="left">
        ...
        <p>
          <a href="userlist.php" class="viewbutton" style="font-weight: bold; text-decoration:none; float:left">Filtered Member Lists </a>
          <form action="useredit.php" method="post" style="float:right">
            Enter UserID or Username: <input type="text" name="member">
