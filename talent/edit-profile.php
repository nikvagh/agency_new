<?php
	...
	if (isset($_POST['contact_tab']) && $_POST['contact_tab'] == 'contact_tab') {

        $sql_t_contact_edit = "UPDATE forum_users 
                            SET
                            user_email = '".$_POST['email']."'
                            WHERE
                            user_id = '".$user_id."'
                        ";
        if(mysql_query($sql_t_contact_edit)){

            $sql_t_contact_edit = "UPDATE agency_profiles 
                            SET
            ...
            if(mysql_query($sql_t_contact_edit)){
                ...
                if(mysql_query($sql_t_contact_edit)){
                    $notification['success'][] = 'Profile Contact Details Upadted Successfully.';
	...
	if(isset($_POST['size_tab']) && $_POST['size_tab'] == 'size_tab'){
		...
		if(isset($_POST['shirt'])){
			$query[] = "shirt = '".$_POST['shirt']."'";
		}
		if(isset($_POST['kids'])){
			$query[] = "kids = '".$_POST['kids']."'";
		}
		if(isset($_POST['glove'])){
			$query[] = "glove = '".$_POST['glove']."'";
		}
		if(isset($_POST['cup'])){
			$query[] = "cup = '".$_POST['cup']."'";
		}
		if(isset($_POST['jacket'])){
			$query[] = "jacket = '".$_POST['jacket']."'";
		}
		if(isset($_POST['pants'])){
			$query[] = "pants = '".$_POST['pants']."'";
		}
		if(isset($_POST['inseam'])){
			$query[] = "inseam = '".$_POST['inseam']."'";
		}
		if(isset($_POST['pants'])){
			$query[] = "pants = '".$_POST['pants']."'";
		}
		...
		if(isset($_POST['waist'])){
			$query[] = "waist = '".$_POST['waist']."'";
		}
		if(isset($_POST['bust'])){
			$query[] = "bust = '".$_POST['bust']."'";
		}
		if(isset($_POST['hips'])){
			$query[] = "hips = '".$_POST['hips']."'";
		}
		if(isset($_POST['dress'])){
			$query[] = "dress = '".$_POST['dress']."'";
		}
		if(isset($_POST['shoe'])){
			$query[] = "shoe = '".$_POST['shoe']."'";
		}
		...
		$query_size_ins = "UPDATE agency_profiles ap
							SET 
							".$query_str."
							WHERE 
							ap.user_id ='$user_id'
						";
		if(mysql_query($query_size_ins)){
			$notification['success'][] = 'Sizes Details Changed Successfully';
		}
	}

	if(isset($_POST['compcard']) && $_POST['compcard'] == 'Save'){
		$query_compcard_update = "UPDATE agency_profiles ap
							SET 
							compcard_type = '".$_POST['compcard_type']."'
							WHERE 
							ap.user_id ='$user_id'
						";
		if(mysql_query($query_compcard_update)){
			$notification['success'][] = 'Compcard Details Saved Successfully';
		}
	}
    ...
    <div class="" id="main">
    		...
    		<div class="row">
	    		...
	    		<div class="col-md-6 text-right">
	    			<button class="btn btn-theme btn-flat" data-target="#print_modal" data-toggle="modal"><i class="fa fa-print"></i></button>
	    		</div>
	    	</div>
			...
			<div class="row">
				        ...
				        <div class="box box-default collapsed-box">
							...
							<?php if($num_reels > 0) { ?>
				            	<div class="box-body">
				            		...
				            		<br/>
				            		<?php while ($row = mysql_fetch_assoc ($result_reel)) { ?>
				        ...
				        <div class="box box-default collapsed-box">
							...
							<?php if($num_vos > 0) { ?>
				            	<div class="box-body">
				            		...
				            		<br/>
				            		<?php while ($row = mysql_fetch_assoc ($result_vo)) { ?>
				            			<div class="row">
		        ...
		        <div class="col-md-4">
		        	...
		        	<form method="post" action="" name="contact_frm" id="contact_frm" enctype="multipart/form-data">
				        <div class="box box-default collapsed-box">
				            <div class="box-header with-border">
				            ...
				            <div class="box-body">
								...
								<div class="form-group">
			              			...
			              			<input type="text" class="form-control" name="cell_phone" id="cell_phone" value="<?php echo $userInfo['cell_phone']; ?>" />
								</div>
				            </div>
				            <div class="box-footer">
				            	<input type="hidden" name="contact_tab" value="contact_tab"/>
				            	<input type="submit" name="submit" value="Save" class="btn btn-success pull-right"/>
				            </div>
				        </div>
				    </form>
		        ...
		        <div class="col-md-4">
		        	...
		        	<form method="post" action="" name="size_frm" id="size_frm" enctype="multipart/form-data">
				        <div class="box box-default collapsed-box">
				            <div class="box-header with-border">
				                <h3 class="no-margin">Sizes</h3>
				                <p>Fashion Sizes</p>
				            ...
				            <div class="box-body">
				            	...
				            	<?php if($userInfo['gender'] == "M" || $userInfo['gender'] == "Transgender"){ ?>
									...
									<div class="form-group">
				              			<label>Kids</label>
				              			<input type="text" class="form-control" name="kids" id="kids" value="<?php echo $userInfo['kids']; ?>" />
									</div>

									<div class="form-group">
				              			<label>Glove</label>
				              			<input type="text" class="form-control" name="glove" id="glove" value="<?php echo $userInfo['glove']; ?>" />
									</div>
									...
									<div class="form-group">
				              			<label>Jacket</label>
				              			<input type="" class="form-control" name="jacket" id="jacket" value="<?php echo $userInfo['jacket']; ?>" />
									</div>

									<div class="form-group">
				              			<label>Pants *</label>
				              			<input type="" class="form-control" name="pants" id="pants" value="<?php echo $userInfo['pants']; ?>" />
									</div>
									...
									<div class="form-group">
				              			<label>Hat</label>
				              			<input type="text" class="form-control" name="hat" id="hat" value="<?php echo $userInfo['hat']; ?>" />
									</div>

				            	<?php } ?>

				            	<?php if($userInfo['gender'] == "F" || $userInfo['gender'] == "Transgender"){ ?>
				            ...
				            <div class="box-footer">
				            	<input type="hidden" name="size_tab" value="size_tab"/>
				            	<input type="submit" name="submit" value="Save" class="btn btn-success pull-right"/>
				            </div>
						...
						<form action="" method="post">
							...
							<div class="col-xs-4">
								...
								<div class="text-center">
									...
									<a href="../pdf_compcard.php?u=<?php echo $user_id; ?>&card_type=large" target="_blank" class="btn btn-theme btn-flat"> View</a>
									<br/><br/>
									<label>
										<input type="radio" name="compcard_type" value="large" <?php if($userInfo['compcard_type'] == 'large'){ echo "checked"; } ?>> click to select
									</label>
								</div>
							</div>
							<div class="col-xs-4">
								...
								<div class="text-center">
									...
									<a href="../pdf_compcard.php?u=<?php echo $user_id; ?>&card_type=thumbnails" target="_blank" class="btn btn-theme btn-flat"> View</a>
									<br/><br/>
									<label>
										<input type="radio" name="compcard_type" value="thumbnails" <?php if($userInfo['compcard_type'] == 'thumbnails'){ echo "checked"; } ?>> click to select
									</label>
								</div>
							</div>
							<div class="col-xs-4">
								...
								<div class="text-center">
									...
									<a href="../pdf_compcard.php?u=<?php echo $user_id; ?>&card_type=compcard" target="_blank" class="btn btn-theme btn-flat"> View</a>
									<br/><br/>
									<label>
										<input type="radio" name="compcard_type" value="compcard" <?php if($userInfo['compcard_type'] == 'compcard'){ echo "checked"; } ?>> click to select
									</label>
								</div>
							</div>
							
							<div class="col-xs-12 text-right">
								<input type="submit" name="compcard" value="Save" class="btn btn-success btn-flat">
							</div>
						</form>
