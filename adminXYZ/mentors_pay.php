...
if(isset($_SESSION['admin'])) {
	...
	echo '<br /><div align="center">Commissions for payments made at least one month ago (<' . $lastmonth . ')<br />
	<div style="background-color:#EEEEEE; padding:15px 15px 15px 15px" align="left">';
